...
gulp.task('material', gulp.series('pugMaterial', 'crearZip', 'borrarMaterial'))
...
gulp.task('ruta', gulp.series('pugRuta', 'crearZipRuta', 'servidor', 'watch'))
    ...
    gulpPrompt.prompt(
      {
        ...
        choices: ['desarrollo', 'produccion', 'salir'],
        pageSize: '5',
      },
      res => {
